//
//  StackNavigationGestureManager.swift
//  SocialMap
//
...
extension NavigationStackFeature.UI {
    ...
    protocol NavigationStackGestureControllable: UIViewController {
    ...
    final class NavigationStackGestureManager: NSObject, UIGestureRecognizerDelegate {
        typealias NavigationStackFlow = NavigationStackFeature.UI.NavigationStackCoordinator
        typealias NavigationStackGestureControllable = NavigationStackFeature.UI.NavigationStackGestureControllable
        typealias HeroTransitionContext = NavigationStackFeature.UI.HeroTransitionContext
        
        private unowned let stackCoordinator: NavigationStackFlow
        private weak var stackControllable: NavigationStackGestureControllable?
        ...
        init(coordinator: NavigationStackFlow) {
            self.stackCoordinator = coordinator
            super.init()
        }
        
        func attach(controllable: NavigationStackGestureControllable) {
