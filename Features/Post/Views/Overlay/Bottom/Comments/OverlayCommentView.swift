...
final class OverlayCommentView: UIView {
    ...
    private func setupLines() {
        ...
        let availableHeight = stackView.frame.height - stackView.layoutMargins.top - stackView.layoutMargins.bottom
        let lineHeight = availableHeight / CGFloat(totalLineCount)

        // 👉 Application correcte à la hauteur du blur
        blurHeightConstraint?.constant = CGFloat(visibleLineCount) * lineHeight + stackView.layoutMargins.top + stackView.layoutMargins.bottom
    }
