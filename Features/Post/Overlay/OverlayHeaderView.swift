...
final class OverlayHeaderView: UIView {
    ...
    private func setupRecommendationTag() {
        ...
        recommendationTag.font = .systemFont(ofSize: UIFont.preferredFont(forTextStyle: .subheadline).pointSize, weight: .bold)
    ...
    private func setupUsernameLabel() {
        usernameLabel.font = .systemFont(ofSize: UIFont.preferredFont(forTextStyle: .footnote).pointSize, weight: .medium)
    ...
    private func setupFollowerLabel() {
        followerLabel.font = .preferredFont(forTextStyle: .caption2)
    ...
    private func setupFollowButton() {
        ...
        config.attributedTitle = AttributedString("Follow", attributes: AttributeContainer().font(.systemFont(ofSize: UIFont.preferredFont(forTextStyle: .caption1).pointSize, weight: .medium)))
